...
async function submit() {
  ...
  try {
    await createPipeline(auth.username, parsed)
...
<template>
  <div>
    ...
    <h1 class="text-2xl font-bold mt-1 mb-6">Create Pipeline</h1>

    <div class="max-w-2xl">
      <label class="block text-sm font-medium mb-2">Pipeline Configuration (JSON)</label>
      <textarea
        v-model="jsonInput"
        rows="12"
